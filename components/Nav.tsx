        ...
        <div className="flex flex-wrap justify-center space-x-3 lg:space-x-6">
          {categories.map((category) => (
            <button
              ...
              className={`flex-1 min-w-[100px] text-sm lg:text-lg p-1 lg:p-2 ${selectedCategory === category ? 'text-white bg-gray-800' : 'text-gray-800'} hover:bg-gray-800 hover:text-white transition-colors`}
            >
